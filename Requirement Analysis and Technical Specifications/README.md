 ...
 * **Δημιουργία λογαριασμού**
 <br>
Η δημιουργία λογαριασμού γίνεται με παρουσίαση φόρμας και συμπλήρωση των στοιχείων σε αυτή. Τα δεδομένα στέλνονται στον server μας και αποθηκεύονται στην SQL βάση μας, αφού πρώτα ο κωδικός γίνει hash με ένα τυχαίο salt. 
<br>
...
<br>
Στη σελίδα του εκάστοτε παρόχου υπάρχει subscription button και πατώντας το ο γονιός έχει τη δυνατότητα να λαμβάνει email και notifications στην πλατφόρμα μας για τα event που διοργανώνει ο συγκεκριμένος πάροχος.